...
class TestSlurmExecutor:
    ...
    def test_start_success(self, mock_api_client, mock_token_manager, executor, mock_conf):
    ...
    @patch("airflow_slurm_executor.slurm_executor.SlurmTokenManager")
    @patch("airflow_slurm_executor.slurm_executor.SlurmAPIClient")
    def test_start_api_not_reachable(self, mock_api_client, mock_token_manager, executor):
    ...
    @patch("airflow_slurm_executor.slurm_executor.SlurmAPIClient")
    def test_execute_async_submission_failure(self, mock_api_client, executor, task_key):
